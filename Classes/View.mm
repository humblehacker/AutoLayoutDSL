...
Constraint View::operator == (const View &rhs)
{
    return Constraint(*this, NSLayoutRelationEqual, rhs);
}

Constraint View::operator == (float rhs)
{
    return Constraint(*this, NSLayoutRelationEqual, View() + rhs);
}

Constraint View::operator <= (const View &rhs)
{
    return Constraint(*this, NSLayoutRelationLessThanOrEqual, rhs);
}

Constraint View::operator <= (float rhs)
{
    return Constraint(*this, NSLayoutRelationLessThanOrEqual, View() + rhs);
}

Constraint View::operator >= (const View &rhs)
{
    return Constraint(*this, NSLayoutRelationGreaterThanOrEqual, rhs);
}

Constraint View::operator >= (float rhs)
{
    return Constraint(*this, NSLayoutRelationGreaterThanOrEqual, View() + rhs);
}
